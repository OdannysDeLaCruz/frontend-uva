      ...
      <div className="container mx-auto">
        ...
        <div className="flex-1 flex items-center px-4 md:px-8 lg:px-16 pt-24 relative z-10 mb -32">
          <div className="text-white backdrop-blur-sm md:backdrop-blur-none bg-purple-900/20 md:bg-transparent p-4 md:p-0 rounded-lg">
            ...
            <p className="text-blue-300 font-bold text-3xl sm:text-4xl md:text-7xl lg:text-[90px]">STARTUP DISRUPTIVA</p>
            <p className="text-white md:text-4xl flex">
              <span className="text-xl md:text-4xl lg:text-5xl italic mb-16">MÁS QUE UN</span>{" "}
              <span className="text-xl md:text-6xl lg:text-7xl italic">CLUB FINTECH</span>
            </p>
          </div>
        </div>
        ...
        <div className="py-4 md:py-8 px-4 md:px-8 lg:px-16 pb-12 md:pb-24 flex flex-col md:flex-row items-center md:items-center gap-4 md:gap-8 relative z-10 mt-16">
          <p className="text-white text-base md:text-xl lg:text-2xl italic backdrop-blur-sm md:backdrop-blur-none bg-purple-900/20 md:bg-transparent p-3 md:p-0 rounded-lg text-center md:text-left">
          ...
          <Link href="/auth/register" className="w-full md:w-auto flex justify-center">
            <Button className="bg-green-600/60 hover:bg-green-700 cursor-pointer text-white px-4 py-2 md:px-6 md:py-5 rounded-lg text-lg md:text-2xl lg:text-3xl font-normal whitespace-nowrap">
              ¡Regístrate ya!
            </Button>
          </Link>
        </div>
