...
interface MembershipSectionProps {
  ...
  membershipStatus?: 'Activa' | 'Inactiva';
}
  ...
  return (
    <div className="flex gap-3 justify-end">
      ...
      <div className="flex flex-col justify-between">
        <p className="text-blue-600 text-xl font-bold leading-none">Aporte Mensual</p>
        <p className="text-blue-600 text-3xl font-bold leading-none">
      ...
      {/* Próximo Aporte */}
      <div className="flex flex-col justify-between">
        <p className="text-blue-600 text-xl font-bold leading-none">Próximo Aporte</p>
        <p className="text-blue-600 text-3xl font-bold leading-none">
      ...
      <div className="flex flex-row items-end">
        <p className="text-white text-3xl font-bold mr-2 leading-none">Membresía</p>
